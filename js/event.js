...
// ***********************
document
  .getElementById("rectangle-value")
  .addEventListener("click", function () {
    ...
    const previousGeometry =
      document.getElementById("geometric-shape").innerText;
    document.getElementById("geometric-shape").innerText =
      previousGeometry + " Rectangle";

    document.getElementById("final-output").innerText =
      previousFinalOutput.innerText;
  });

// Parallelogram Section
// **************************
document
  .getElementById("parallelogram-value")
  .addEventListener("click", function () {
    const base = 10;
    const height = 12;
    ...
    const previousGeometry =
      document.getElementById("geometric-shape").innerText;
    document.getElementById("geometric-shape").innerText =
      previousGeometry + " Parallelogram";
